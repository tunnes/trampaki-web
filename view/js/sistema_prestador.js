...
//  VISUALIZAR MEU PERFIL ------------------------------------------------------
    var setPerfilPrestador = function (data) {
...
//  VISUALIZAR TODOS OS MEUS SERVIÇOS ------------------------------------------
    var setServicos = function (data) {
        console.log(data);
        //var servicos = document.getElementById('servicos');
        var servicos = document.createElement('div'); // WTF IS THIS?
        servicos.innerHTML = ' ';
...
//  VISUALIZAR SOLICITAÇÕES ----------------------------------------------------
    var setSolicitacoesPrestador = function (data) {
