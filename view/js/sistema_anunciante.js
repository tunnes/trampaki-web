...
/*  VISUALIZAR MEU PERFIL --------------------------------------------------- */
    var setperfilAnunciante = function (data) {
...
//  VISUALIZAR PERFIL DO PRESTADOR ---------------------------------------------
    var setVisualizarPrestador = function (data) {
    ...
    function visualizarPrestador(codigo) {
         pageCaller("/view/ajax/prestador-perfil.html",
                   {func: setVisualizarPrestador, resource: "/carregar-perfil-prestador/" + codigo, met: "GET"}, headerAnunciante);
    }
        ...
        $("form").submit(function(){
            var formData = new FormData($(this)[0]);
                $.ajax({
                    ...
                    processData: false,
                    beforeSend: function () {
                         $("#loading-frame .center-loading span").html("ENVIANDO 0%");
                    ...
                    xhr: function () {
                        ...
                        xhr.upload.onprogress = function (e) {
                           ...
                           $("#loading-frame .center-loading span").html("ENVIANDO " + porcentagem);
                    ...
                    statusCode: {
                        400:function(data) {
                            ...
                            $("#loading-frame .center-loading span").html("CARREGANDO");
...
//  VISUALIZAR MEU ANUNCIO -----------------------------------------------------
    var setVisualizarMeuAnuncio = function (data) {
        console.log(data);
        carregarCategorias(data.categorias);
    ...
    function visualizaMeuAnuncio(codigoAnuncio) {
        pageCaller("/view/ajax/visualizar-anuncio.html",
                   {func: setVisualizarMeuAnuncio, resource: "/carregar-anuncio/" + codigoAnuncio,
                    met: "GET"}, headerAnunciante);
        }
...
//  VISUALIZAR TODOS OS MEUS ANUNCIOS ------------------------------------------
    ...
    // SET MEUS ANUNCIOS
    var setMeusAnuncios = function (data) {
...
//  VISUALIZAR SOLICITAÇÕES ----------------------------------------------------
    var setVisualizarSolicitacoes = function (data) {
